...
<body>
    ...
    </header><div class="categoria" style="float:left; display:block;">
        <?php
    ...
    <div id="properros">
        <section id="pro">
            <div class="conta">
                <?php
                        require("conexion.php");
                        $consulta = "SELECT * FROM producto WHERE Especie='Perro' ORDER BY Categoria ASC";
                        $resultado = $conexion->query($consulta);
                        while ($fila = $resultado->fetch_assoc()) {
                            if($fila['Categoria']==1){
                                ?>
